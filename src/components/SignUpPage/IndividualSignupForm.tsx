import type { IndividualUserCredentials } from "@/types";
...
type IndividualSignupFormData = Omit<IndividualUserCredentials, "userId">;
...
export const IndividualSignupForm = () => {
  ...
  const onSubmit = (data: IndividualUserCredentials) => {
    // Logic for sign up
